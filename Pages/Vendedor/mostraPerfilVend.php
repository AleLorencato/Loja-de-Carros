...
<body>
  ...
  <main>
    ...
    <div class="container">
      ...
      <div class="">
        <a href="./altera_perfil_vend.php" class="btn-small indigo lighten-1">Alterar Dados Do perfil</a>
        <a href="./listarCarros-adm.php" class="btn-small indigo lighten-1">Voltar</a>
      </div>
