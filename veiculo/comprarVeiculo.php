...
<body>
    ...
    <main>
        ...
        foreach ($carros as $carro) {
            ?>
            <section>
                <!-- style=" background-color: #e2def7; border-radius: 4px; width:150px; height: 130px; padding: 6px;" -->
                <div class="card">
                ...
                <form action="../includes/logica/logica_pessoa.php" method="post">
                    <button type="submit" class="btn-primary" name="comprar" value="<?php echo $carro['codveiculo']; ?>">
                        Comprar </button>
                </form>
